...
open class MainActivity : FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        val meshChannel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.ultimate.jarvis/mesh")
        meshChannel.setMethodCallHandler(MeshBridge(this, meshChannel))
